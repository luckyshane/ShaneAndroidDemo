...
public class CornerLayoutActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        int peekWeight = ContextUtil.dip2px(this, 50);
        collpaseMarginLeft = ContextUtil.getScreenWidth(this) - peekWeight;
        collapseRcLayout(0);
    }

    private void expandRcLayout(int duration) {
        ObjectAnimator animator = getCollpaseAnimator();
        animator.cancel();
    ...
    private ObjectAnimator getCollpaseAnimator() {
