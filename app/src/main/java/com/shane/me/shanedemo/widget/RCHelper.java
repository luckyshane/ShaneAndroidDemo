...
public class RCHelper {
    ...
    public void initAttrs(Context context, AttributeSet attrs) {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.RCRelativeLayout_stroke_color, 0);
        mClipBackground = ta.getBoolean(R.styleable.RCRelativeLayout_clip_background, false);
